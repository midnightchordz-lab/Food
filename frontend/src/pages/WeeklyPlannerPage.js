...
const WeeklyPlannerPage = () => {
  ...
  const createSamplePlan = async () => {
    const sampleMeals = {
      Monday: { breakfast: 'Energizing smoothie bowl', lunch: 'Quinoa salad', dinner: 'Grilled salmon' },
      Tuesday: { breakfast: 'Oatmeal with berries', lunch: 'Chicken wrap', dinner: 'Pasta primavera' },
      Wednesday: { breakfast: 'Greek yogurt parfait', lunch: 'Veggie stir-fry', dinner: 'Turkey meatballs' },
      Thursday: { breakfast: 'Avocado toast', lunch: 'Lentil soup', dinner: 'Baked chicken' },
      Friday: { breakfast: 'Protein pancakes', lunch: 'Sushi bowl', dinner: 'Pizza night' },
      Saturday: { breakfast: 'French toast', lunch: 'Burrito bowl', dinner: 'Homemade curry' },
      Sunday: { breakfast: 'Brunch spread', lunch: 'Roasted vegetables', dinner: 'Comfort meal prep' }
    };
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-start mb-12">
          <div>
            ...
            <p className="text-muted-foreground" data-testid="page-description">
              Plan your mood-based meals for the entire week.
            </p>
          </div>
          <Button
        ...
        {plans.length === 0 ? (
          <div className="text-center py-20 bg-card rounded-3xl border border-border/40" data-testid="empty-state">
            ...
            <p className="text-muted-foreground">Create your first weekly plan to get started!</p>
          </div>
        ) : (
          <div className="space-y-8">
            {plans.map((plan, planIdx) => (
              ...
              >
                <h3 className="text-2xl font-serif mb-6">Week of {new Date(plan.week_start).toLocaleDateString()}</h3>
